  ...
  if &background ==# 'dark' "{{{
    if a:style ==# 'default' "{{{
      let palette = {
            ...
            \ 'bg_blue':       ['#354157',   '17'],
            \ 'bg_purple':     ['#493c53',   '54'],
            \ 'filled_red':    ['#ec7279',   '203'],
            \ 'filled_green':  ['#a0c980',   '107'],
            \ 'filled_blue':   ['#6cb6eb',   '110'],
            \ 'filled_purple': ['#d38aea',   '176'],
            \ 'red':           ['#ec7279',   '203'],
            \ 'yellow':        ['#deb974',   '179'],
            \ 'green':         ['#a0c980',   '107'],
            \ 'cyan':          ['#5dbbc1',   '72'],
    ...
    let palette = {
          ...
          \ 'bg_grey':       ['#bcc5cf',   '246'],
          \ 'bg_red':        ['#f6e4e4',   '217'],
          \ 'bg_yellow':     ['#f0ece2',   '183'],
          \ 'bg_green':      ['#e5eee4',   '150'],
          \ 'bg_blue':       ['#e3eaf6',   '153'],
          \ 'bg_purple':     ['#f4e9f8',   '189'],
          \ 'filled_red':    ['#e17373',   '167'],
          \ 'filled_green':  ['#76af6f',   '107'],
          \ 'filled_blue':   ['#6996e0',   '68'],
          \ 'filled_purple': ['#bf75d6',   '134'],
          \ 'fg':            ['#4b505b',   '240'],
          \ 'red':           ['#d05858',   '167'],
          \ 'yellow':        ['#be7e05',   '172'],
          \ 'green':         ['#608e32',   '107'],
